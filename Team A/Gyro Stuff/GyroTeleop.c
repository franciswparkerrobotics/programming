...
//LeftRear set is the front-left motor and the back-right motor, and RightFront set is the other two motors
...
task superDrive(){
	...
	while(true){
		...
		// starts free-spinning mode
	  	...
	  	motor[LeftFront] = FLset*movementAmount+turning*turningAmount;
			motor[RightFront] = FRset*movementAmount-turning*turningAmount;
			motor[LeftRear] = FRset*movementAmount+turning*turningAmount;
			motor[RightRear] = FLset*movementAmount-turning*turningAmount;
		} else {
