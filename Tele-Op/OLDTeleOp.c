...
// dead spot adjustments for x1, y1, x2, y2 analog controls
...
// mechanum drive variables and motor commands
	  int rfdrive = joystick.joy1_y1 + joystick.joy1_x1 - joystick.joy1.x2;
	  motor[RightFront] = rfdrive;

	  int lfdrive = joystick.joy1_y1 - joystick.joy1_x1 + joystick.joy1.x2;
	  motor[LeftFront] = lfdrive;

	  int rrdrive = joystick.joy1_y1 - joystick.joy1_x1 - joystick.joy1.x2;
	  motor[RightRear] = rrdrive;

	  int lrdrive = joystick.joy1_y1 + joystick.joy1_x1 + joystick.joy1.x2;
